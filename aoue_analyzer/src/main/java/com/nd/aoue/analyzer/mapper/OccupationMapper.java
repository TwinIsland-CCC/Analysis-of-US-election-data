 ...
 * 分析数据mapper
 */
public class OccupationMapper extends TableMapper<Text,Text> {
    @Override
...
*/
        ...
        System.out.println(contbr_occupation);

        //将数据写给reducer
        context.write(new Text(contbr_occupation),new Text(contb_receipt_amt));//写给它的是总金额数据
